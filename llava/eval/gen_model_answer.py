        ...
        for i in range(num_choices):
            ...
            for j in range(len(question["turns"])):
                ...
                if use_random_cocoimage:
                    ...
                    image_tensor = image_processor.preprocess(random_cocoimage, return_tensors='pt')['pixel_values'][0]
                # some models may error out when generating long outputs
                try:
                    # If we do use the random image, need to pass the image tensor to the model
                    if use_random_cocoimage:
