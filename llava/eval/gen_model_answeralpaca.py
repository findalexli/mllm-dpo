...
def run_eval(
    ...
    questions = [item['instruction'] for item in eval_set]
...
def get_model_answers(
    ...
    # model = AutoModelForCausalLM.from_pretrained("lmsys/vicuna-13b-v1.5", device_map="cuda")
    # If evaluating vicuna 
     
    for question in tqdm(questions):

        torch.manual_seed(42)
        conv = conv_templates[args.conv_mode].copy()
        # qs = question + '\nPlease answer the question such that your response is in the following attributes in 5-point Likert scale:\nHelpfulness:4,Correctness:4,Coherence:4,Complexity:4,Verbosity:4'
        qs = question
        ...
        if temperature < 1e-4:
            ...
            do_sample = True
        conv.stop_str = conv.sep if conv.sep_style != SeparatorStyle.TWO else conv.sep2
        ...
        try:
            ...
            # LLava models don't have stop_token_ids
            ...
            print("ERROR question ID: ", question)
            output = "ERROR"
