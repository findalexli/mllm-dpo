...
DATA_DIR="/home/ubuntu/latest_llava/LLaVA/playground/data/dpo/0105_self-sampled/data_noisy_experiment"

# Updated base name for your run
BASE_RUN_NAME="llava-13b-dpo-lora-0206_data-noising"
...
for FILE_PATH in $DATA_DIR/subset_*.json; do
