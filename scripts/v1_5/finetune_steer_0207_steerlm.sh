...
# Subsets directory
SUBSETS_DIR=/home/ubuntu/latest_llava/LLaVA/playground/data/steerlm_data_scaling/data_scaling_rejection_sampling
...
for PERCENTAGE in 25 50 75; do
    ...
    RUN_NAME="LLaVa_SteerLM_${PERCENTAGE}%_lora_data_scaling"
